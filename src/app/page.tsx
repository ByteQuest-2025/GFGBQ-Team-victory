...
export default function VoiceShield() {
  ...
  useEffect(() => {
    ...
    if (view === 'active') {
      ...
      // Use wss for production, ws for local. hostname handles both.
  ...
  const startSpeechRecognition = () => {
    ...
    recognitionRef.current.onerror = (event: any) => {
      ...
      // Removed the auto-restart loop to prevent infinite recursion
    };
        ...
        <div className="animate-fade-in">
              ...
              <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap', marginTop: '0.5rem' }}>
                {[
                  ...
                  <button
                    ...
                    className={selectedLang === lang.val ? 'lang-btn active' : 'lang-btn'}
                    style={{
                      padding: '10px 15px',
                      borderRadius: '12px',
          ...
          <div className="glass-card" style={{ marginTop: '1.5rem' }}>
            ...
            <p style={{ fontSize: '0.85rem', color: 'var(--text-secondary)' }}>
              We only analyze audio locally via your microphone when protection is active.
            </p>
          </div>
        </div>
      )}
